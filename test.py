...
if __name__ == '__main__':
    ...
    prs.add_argument("-d", dest="decay", type=float, default=0.9, required=False, help="Epsilon decay.\n")
    ...
    out_csv = 'outputs/single-intersection/{}_alpha{}_gamma{}_eps{}_decay{}'.format(experiment_time, args.alpha, args.gamma, args.epsilon, args.decay).replace(':', '-')
    ...
    for run in range(1, args.runs+1):
        ...
        if args.fixed:
            ...
            while not done['__all__']:
                ...
                system_total_waiting_time.append(env.metrics[-1])
